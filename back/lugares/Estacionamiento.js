...
EstacionamientoRouter.get('/', async (req, res) => {
    try {
...
EstacionamientoRouter.post('/ocupar', 
    ...
    try {
       ...
       // Ocupo el lugar asignado al id que se paso x el body 
        ...
        // Asignar id_tarifa según el tipo de vehículo
        if (id_vehiculo === 1) {
            id_tarifa = 1; // Usar el id_tarifa correspondiente a "Automóvil"
        } else if (id_vehiculo === 2) {
            id_tarifa = 2; // Usar el id_tarifa correspondiente a "Motocicleta"
        } else {
            id_tarifa = 3; // Usar el id_tarifa correspondiente a "Camioneta"
        }
        ...
        await db.query(
            ...
            [id_lugar, id_vehiculo, id_tarifa]
        );
...
EstacionamientoRouter.post('/liberar', async (req, res) => {
    try {
